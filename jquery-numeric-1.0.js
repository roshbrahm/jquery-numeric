...
(function($) {
  $.fn.numeric = function(config, callback) {
    ...
    if (embedNumpad) {
      ...
      keypad += "<span class='togglePad_" + numpadId + " ' title='Toggle Numpad.'style='float:right;'><span class='arr-down'></span></span>";
      keypad += "</div>"
      keypad += "<div id='numpadContent_" + numpadId + "'>";
      keypad += "<div class='data-row'>";
      ...
      keypad += "</div>";
      keypad += "<div class='data-row'>";
      keypad += "<span class='" + numpadId + "_key key' id='" + numpadId + "_left'>&larr;</span>";
      keypad += "<span class='" + numpadId + "_key key' id='" + numpadId + "_right'>&rarr;</span>";
      keypad += "</div>";
      keypad += "<div class='data-row'>";
